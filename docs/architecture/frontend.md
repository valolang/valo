...
1.  **Preprocessor (`core/src/preprocessor.rs`):**
...
3.  **Parser (`core/src/parser/`):**
    ...
    *   Builds a high-fidelity Abstract Syntax Tree (AST).
    *   Supports both modern Valo syntax and VBA-style declarations (Attributes, `Type`, etc.).

4.  **Semantic Validator (`core/src/semantics/`):**
...
5.  **Module Loader (`core/src/modules.rs`):**
